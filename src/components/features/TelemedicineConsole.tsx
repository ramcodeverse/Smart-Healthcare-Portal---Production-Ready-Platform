...
import { Video, VideoOff, Mic, MicOff, Phone, PhoneOff, MessageSquare, Monitor } from 'lucide-react';
...
const TelemedicineConsole = () => {
  ...
  const startCall = (patient: CallItem) => {
            ...
            <div className="bg-gray-800 border-t border-gray-700 p-4">
              <div className="max-h-40 overflow-y-auto space-y-2 mb-3">
                {chatMessages.length === 0 ? (
                  <p className="text-gray-400 text-sm text-center">No messages yet. Send a message to the patient.</p>
                ) : (
                  chatMessages.map((msg) => (
                    <div key={msg.id} className="text-sm">
                      <span className="text-blue-400 font-medium">[{msg.timestamp}] You: </span>
