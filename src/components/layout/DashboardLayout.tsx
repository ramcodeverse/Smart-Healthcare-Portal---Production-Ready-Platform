...
import { Heart, Bell, Settings, LogOut, Menu, QrCode } from 'lucide-react';
...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              {/* Scan Medication QR Button */}
              <button
                onClick={() => setScannerModalOpen(true)}
                title="Scan & Decode Medication QR"
                className="bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 px-3 py-1.5 rounded-xl font-bold text-xs transition-colors flex items-center gap-1.5 shadow-2xs"
              >
                <QrCode className="w-4 h-4 text-blue-600" />
                <span className="hidden sm:inline">Scan Medication QR</span>
              </button>
      ...
      {/* Global Medication QR Scanner Modal */}
